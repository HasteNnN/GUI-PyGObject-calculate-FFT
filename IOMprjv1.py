...
class MyWindow(Gtk.Window):
    ...
    def __init__(self):  # c-tor
        ...
        self.notebook.append_page(self.page2, Gtk.Label("Cerinta A"))
        ...
        self.page2.attach(button2, 4, 5, 1, 1)
        self.page2.attach(self.label12, 4, 6, 1, 1)
        ...
        self.notebook.append_page(self.page3, Gtk.Label("Cerinta B"))
        ...
        self.page6 = Gtk.Grid(column_homogeneous=False,
                         column_spacing=10,
                         row_spacing=30)
        self.notebook.append_page(self.page6, Gtk.Label("Cerinta C"))
        ...
        self.page6.attach(self.label15, 1, 1, 1, 1)
        self.page6.attach(image2, 0, 2, 1, 1)
